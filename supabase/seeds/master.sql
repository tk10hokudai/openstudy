...
-- 列順: (id, title, category, description, created_at, sort_order)
-- sort_order: 五十音・アルファベット順の表示順（新試験追加時はここに追記）
INSERT INTO exams (id, title, category, description, created_at, sort_order) OVERRIDING SYSTEM VALUE VALUES
  (1, '基本情報技術者試験',         'IT系',  '情報処理推進機構(IPA)が実施する国家試験。ITエンジニアの基礎知識を問う。', now(), 1),
  (2, 'TOEIC L&R',                 '語学系', '英語のリスニング・リーディング能力を測定する国際的な試験。',               now(), 5),
  (3, 'SPI試験',                   '就職',   '就職活動で広く使用される適性検査。言語・非言語の2分野で構成される。',       now(), 4),
  (4, 'TOEIC L&R【単語集】',       '語学系', 'TOEICに頻出の英単語を初級・中級・上級の3レベルに分類した単語練習集。',    now(), 6),
  (5, '基本情報技術者試験【用語集】','IT系', '基本情報技術者試験に頻出のIT用語を分野別に分類した用語練習集。',             now(), 2);
  -- ※ id=6（プログラミング言語【python】, sort_order=3）は migration 20260425200000 で挿入済み
...
INSERT INTO exam_sections OVERRIDING SYSTEM VALUE VALUES
  ...
  -- ※ exam_id=6（プログラミング言語【python】）と section_id=40 は
  --    migration 20260425200000_add_python_exam.sql で挿入済みのため除外
